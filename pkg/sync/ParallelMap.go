...
// slice. It function is executed in a Go Routine so they run in parallel. It returns a future containing the
// results of the calling the function on each element. If any function calls return an error, the future completes
// early and no results are returned.
